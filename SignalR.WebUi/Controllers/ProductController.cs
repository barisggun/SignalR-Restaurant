...
namespace SignalR.WebUI.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.GetAsync("https://localhost:7224/api/category");
        ...
        public async Task<IActionResult> CreateProduct(CreateProductDto createProductDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7224/api/product", stringContent);
        ...
        public async Task<IActionResult> UpdateProduct(int id)
        {
			...
			var response1 = await client1.GetAsync("https://localhost:7224/api/category");
